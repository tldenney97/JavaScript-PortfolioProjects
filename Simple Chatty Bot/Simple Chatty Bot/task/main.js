...
//Declare the correct answer and the input
function test() {
    console.log("Let's test your programming knowledge.");
    return questionOne();

//Create a nested function for each question in the test.
    ...
    function checkerOne() {
        ...
        let correctAnswer = ("2");
//Create an if/else statement to check for the correct answer
